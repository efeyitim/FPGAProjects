-- VHDL Entity edid_lib.edid_top.symbol
--
-- Created:
--          by - berkayyitim.Domain Users (BERKAYYITIM-WS)
--          at - 15:23:38 07/20/23
--
...
--
-- VHDL Architecture edid_lib.edid_top.struct
--
-- Created:
--          by - berkayyitim.Domain Users (BERKAYYITIM-WS)
--          at - 15:23:38 07/20/23
...
architecture struct of edid_top is
    ...
    for all : aux_controller use entity edid_lib.aux_controller;
    for all : aux_interface use entity edid_lib.aux_interface;
    for all : cdc_single_bit_sync use entity edid_lib.cdc_single_bit_sync;
    for all : debounce_filter use entity edid_lib.debounce_filter;
    for all : edid_ram use entity edid_lib.edid_ram;
    for all : pll_50 use entity edid_lib.pll_50;
    for all : reset_delay use entity edid_lib.reset_delay;
    for all : reset_synchronizer use entity edid_lib.reset_synchronizer;
    -- pragma synthesis_on
